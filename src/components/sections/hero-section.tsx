...
export function HeroSection() {
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden">
      ...
      <div className="relative mx-auto flex w-full max-w-7xl flex-col items-center gap-12 px-6 py-32 text-center">
        <motion.h1
        ...
        >
          Cambodia&apos;s premier online marketplace. Find vehicles, property,
          electronics, jobs, and more from trusted sellers.
        </motion.p>
